...
function ConatactFormInline(){
    const [ formData, setFormData] = useStatef({name:"", email: "", subject:"", message:""}):
    const [status, setStatus] = useState(mull); //null|sending|sent|error
